...
from custom_components.hojo_tts.const import DOMAIN
from custom_components.hojo_tts.entity import device_for
from custom_components.hojo_tts.models import ModelInfo

_ROOT = pathlib.Path(__file__).resolve().parent.parent
_COMPONENT = _ROOT / "custom_components" / "hojo_tts"
...
class TestTranslations:
    ...
    def test_every_sensor_has_a_name(self) -> None:
        from custom_components.hojo_tts.sensor import DESCRIPTIONS
