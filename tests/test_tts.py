...
from custom_components.hojo_tts.tts import HojoTTSEntity, _expand_languages
...
class TestTextOptions:
    ...
    def _options(
        ...
        return HojoTTSEntity._text_options(None, language, given or {})  # type: ignore[arg-type]
